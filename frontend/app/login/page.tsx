          ...
          <div className="flex flex-col items-center space-y-1.5 pb-4 pt-6 px-6">
            ...
            <div className="space-y-0.5 flex flex-col items-center">
              ...
              <p className="text-gray-600">
                Sign in to your SkillChain account
              </p>
            </div>
          </div>
        ...
        <div className="mt-6">
          <div className="bg-white border border-gray-200 p-4 rounded-lg shadow-sm">
            <p className="text-xs text-gray-600 text-center">
              <strong className="text-gray-900">New to SkillChain?</strong> Join
              as a developer to verify your skills, as an employer to find
              verified talent, or as an educator to create assessments.
            </p>
          </div>
        </div>
      </div>
